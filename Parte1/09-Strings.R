...
# Dividindo um string em caracteres, após o caracter espaço
...
arquivo <- read.csv("/home/leandro/teste_performance_disco.txt")

head(arquivo)
tail(arquivo)

str_count(as.matrix(arquivo), "7")
str_locate_all(as.matrix(arquivo), "7")
